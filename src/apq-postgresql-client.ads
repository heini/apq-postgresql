...
-------------------------------------------------------------------------------
-- This is the PostreSQL driver for APQ.                                     --
-- Here you'll find the base implementation of all the abstract functions in --
-- APQ package and a custom blob implementation tailored for PostgreSQL only.--
-------------------------------------------------------------------------------
